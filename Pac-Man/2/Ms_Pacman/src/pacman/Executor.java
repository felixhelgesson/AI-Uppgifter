...
import neuralNetwork.ControllerNeuralNet;
...
{	
	...
	public static void main(String[] args)
	{
		...
		//Experiment
		//exec.runExperiment(new ControllerNeuralNet(),new RandomGhosts(),numTrials);
		//exec.runExperiment(new MyPacmanController(),new RandomGhosts(),numTrials);
		...
		//Call agent here
		//exec.runGame(new ControllerNeuralNet(),new StarterGhosts(),true, 10);
		exec.runGame(new MyPacmanController(),new StarterGhosts(),true, 10);
