...
import pacman.controllers.examples.Assignment.AssignmentController;
import ANN.ANNController;
...
{	
	...
	public static void main(String[] args)
	{
		...
		int numTrials=100;
		//exec.runExperiment(new ANNController(),new StarterGhosts(),numTrials);
		...
		exec.runGame(new ANNController(),new StarterGhosts(),true, 10);
        //exec.runGame(new AssignmentController(),new RandomGhosts(),true, 10);
